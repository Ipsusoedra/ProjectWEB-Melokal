...
$query = mysqli_query($koneksi, "SELECT * FROM tb_ukuran WHERE id_ukuran
= '$id_ukuran'");
                            ...
                            <div class="card card-primary">
                                ...
                                <form action="proses_edit.php" method="POST" enctype="multipart/form-data"">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_ukuran" id="nama_ukuran" class="form-control" value="<?= $nama_ukuran ?>" required>
                                    </div>
                                    <div class="form-group">
