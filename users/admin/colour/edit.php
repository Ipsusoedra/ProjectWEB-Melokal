                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                ...
                                <form action="proses_edit.php" method="POST" enctype="multipart/form-data"">
                                    ...
                                    <center><img src="../../assets/img/<?= $gambar_warna ?>" style="object-fit: cover;" alt="" class="rounded-circle" width="200px" height="200px"></center>
                                    <div class="form-group">
                                        <label>Pilih Gambar</label>
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" name="gambar_warna" class="custom-file-input" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_warna" id="nama_warna" class="form-control" value="<?= $nama_warna ?>" required>
                                    </div>
