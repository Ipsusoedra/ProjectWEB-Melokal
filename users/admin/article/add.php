                            ...
                            <div class="card card-primary">
                                ...
                                <form action="proses_simpan.php" method="POST" enctype="multipart/form-data"">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="judul_artikel" id="judul" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="isi">Isi</label>
                                        <textarea id="isi" name="isi_artikel" class="form-control" rows="4" required></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="nama_penulis" name="nama_penulis" class="form-control custom-select">
                                            <option selected disabled>Select one</option>
                                            <?php while ($result = mysqli_fetch_array($query)) { ?>
