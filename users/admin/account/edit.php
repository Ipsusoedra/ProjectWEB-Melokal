...
$gambar_user = $result['gambar_user'];
                            ...
                            <div class="card card-outline card-primary">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img name="" class="profile-user-img img-fluid img-circle" style=" width: 150px; height: 150px; object-fit: cover; " src="../../assets/img/<?= $gambar_user ?>" alt="User profile picture">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="gambar_user" class="custom-file-input" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_telp" id="no_telp" class="form-control" value="<?= $no_telp ?>" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" id="col_password" class="form-control" value="<?= $password ?>" required>
                                </div>

                                <div class="form-group">
                                    <label for="confirm_password">confirm password</label>
                                    <input type="password" name="confirm_password" id="confirm_password" class="form-control" value="<?= $confirm_password ?>" required>
                                </div>
