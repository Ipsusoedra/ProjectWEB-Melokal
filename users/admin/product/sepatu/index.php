                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <img alt="Avatar" class="table-avatar rounded-circle img-bordered " style="object-fit: cover;" src="../../../assets/img/<?= $result['gambar_produk']; ?>" width="50px" height="50px">
                          </td>
                          <td><?= $result['nama_produk'] ?></td>
                          <td><?= substr($result['deskripsi_produk'], 0, 70) . '...' ?></td>
                          <td><?= $result['stok'] ?></td>
                          ...
                          <td class="project-actions text-right">
                            <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#exampleModal<?= $result['id_produk']; ?>" data-whatever="@mdo" href="#exampleModal<?= $result['id_produk']; ?>">
                              <i class="fas fa-eye">
                              </i>
                              View
                            </a>
                            <a class="btn btn-success btn-sm" href="edit.php?id_produk=<?= $result['id_produk']; ?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                            </a>
                            <a class="btn btn-danger btn-sm" href="proses_hapus.php?id_produk=<?= $result['id_produk']; ?>">
                        ...
                        <div class="modal fade" id="exampleModal<?= $result['id_produk']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content bg-primary ">
                              ...
                              <div class="modal-body">
                                ...
                                <div class=" card-body">
                                  ...
                                  <center><img src="../../../assets/img/<?= $result['gambar_produk']; ?>" style="object-fit: cover;" alt="" class="rounded-circle" width="200px" height="200px"></center>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea disabled id="deskripsi" name="deskripsi_produk" class="form-control" rows="4" required><?= $result['deskripsi_produk']; ?></textarea>
                                  </div>
                                  <div class="form-group">
