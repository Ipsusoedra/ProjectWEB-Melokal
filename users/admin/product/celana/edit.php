...
$query = mysqli_query($koneksi, "SELECT tb_produk.*, tb_merek.nama_merek, tb_kategori.nama_kategori, tb_warna.nama_warna, tb_ukuran.nama_ukuran 
FROM tb_produk 
INNER JOIN tb_kategori 
ON tb_produk.id_kategori = tb_kategori.id_kategori 
INNER JOIN tb_merek ON tb_produk.id_merek = tb_merek.id_merek 
INNER JOIN tb_warna ON tb_produk.id_warna = tb_warna.id_warna 
INNER JOIN tb_ukuran ON tb_produk.id_ukuran = tb_ukuran.id_ukuran
                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                ...
                                <div class=" card-body">
                                    ...
                                    <center><img src="../../../assets/img/<?= $gambar_produk ?>" style="object-fit: cover;" alt="" class="rounded-circle" width="200px" height="200px"></center>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="deskripsi" name="deskripsi_produk" class="form-control" rows="4" required><?= $deskripsi_produk ?></textarea>
                                    </div>
                                    <div class="form-group">
