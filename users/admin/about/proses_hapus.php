...
$query = mysqli_query($koneksi, "SELECT * FROM tb_about WHERE id_about
= '$id_about'");
$data = mysqli_fetch_array($query);
$nama_file = $data['gambar_about'];
unlink('../../../users/assets/img/' . $nama_file);
//

//hapus data dari database
$hapus = mysqli_query($koneksi, "DELETE FROM tb_about WHERE id_about =
'$id_about'");
