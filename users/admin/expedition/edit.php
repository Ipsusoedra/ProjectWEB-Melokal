...
$gambar_ekspedisi = $result['gambar_ekspedisi'];
$nama_ekspedisi = $result['nama_ekspedisi'];
$harga_ekspedisi = $result['harga_ekspedisi'];
//
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                ...
                                <form action="proses_edit.php" method="POST" enctype="multipart/form-data"">
                                    ...
                                    <center><img src="../../assets/img/<?= $gambar_ekspedisi ?>" style="object-fit: cover;" alt="" class="rounded-circle" width="200px" height="200px"></center>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_ekspedisi" id="nama_ekspedisi" class="form-control" value="<?= $nama_ekspedisi ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <input type="text" name="harga_ekspedisi" id="harga_ekspedisi" class="form-control" value="<?= $harga_ekspedisi ?>" required>
                                            </div>
                                        </div>
                                    </div>
