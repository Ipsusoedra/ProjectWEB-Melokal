...
<body>
  ...
  <div class="container">
    <div class="row d-flex justify-content-center ">
      <div class="col-md-6 col-lg-4 my-5 py-5 ">
        <form action="proses_login.php" method="POST" class="border border-2 rounded-5 p-5" enctype="multipart/form-data">
          <?php
          include '../../koneksi.php';
          $no = 1;
          $query = mysqli_query($koneksi, "SELECT * FROM tb_about
          ...
          ?>
            <center>
              <img class="mb-4" src="../../assets/img/<?= $result['gambar_about']; ?>" alt="" width="100px" height="100px" />
            </center>
          ...
          <button type="submit" name="submit" class="btn btn-primary mb-3 w-100 ">Login</button>
        </form>
      </div>
    </div>
  </div>
